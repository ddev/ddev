...
var WebTag = "20201229_php7.4" // Note that this can be overridden by make
...
var RouterTag = "20201227_travis_router_http2_max_header" // Note that this can be overridden by make
