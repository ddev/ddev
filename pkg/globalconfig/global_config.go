...
# use_docker_buildx_from_path: false
# This should only be used in specific cases like troubleshooting.
...
// DockerBuildxVersion is filled with the version we find for docker-buildx
var DockerBuildxVersion = ""
...
func GetRequiredDockerBuildxVersion() string {
	return DdevGlobalConfig.RequiredDockerBuildxVersion
}
