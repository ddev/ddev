...
var WebTag = "v1.25.1" // Note that this can be overridden by make
...
// RequiredDockerBuildxVersionDefault defines the required version of docker-buildx
const RequiredDockerBuildxVersionDefault = "v0.31.1"
