...
func PowerOff() {
	...
	_, _, err = dockerutil.RunSimpleContainer(version_constants.BusyboxImage, "", []string{"sh", "-c", "rm -f /mnt/ddev-global-cache/custom_certs/*"}, []string{}, []string{}, []string{"ddev-global-cache" + ":/mnt/ddev-global-cache"}, "", true, false, nil)
	if err != nil {
