...
- `info_command`: (optional) A script that returns a human-readable description of the target environment for use in the push warning message. The command should output a simple string like `site.env`
