...
func (app *DdevApp) Snapshot(snapshotName string) (string, error) {
	...
	if globalconfig.DdevGlobalConfig.NoBindMounts {
		...
		c := fmt.Sprintf("ls -ld /mnt/ddev_config && ls -l /mnt/ddev_config && set -x && id && mkdir -p /mnt/ddev_config/db_snapshots && ls -ld /mnt/ddev_config/db_snapshots && chmod 777 /mnt/ddev_config/db_snapshots && ls -ld /mnt/ddev_config/db_snapshots && cp -r %s /mnt/ddev_config/db_snapshots", containerSnapshotDir)
		uid, _, _ := util.GetContainerUIDGid()
