...
// See SkipIfEmbargoed for usage examples.
func IsTestEmbargoed(testName string) bool {
	embargoList := os.Getenv("DDEV_EMBARGO_TESTS")
	if embargoList == "" {
		return false
	}
...
//	}
//
// Running tests with embargoed tests:
//
//	# Skip a single test
