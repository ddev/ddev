...
func init() {
	...
	configGlobalCommand.Flags().StringVarP(&webEnvironmentGlobal, "web-environment", "", "", `Set the environment variables in web container: --web-environment="TYPO3_CONTEXT=Development,SOMEENV=someval"`)
