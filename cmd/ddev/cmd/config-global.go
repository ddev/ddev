...
func init() {
	...
	configGlobalCommand.Flags().String("table-style", "", fmt.Sprintf(`Table style for list and describe, possible values are "%s"`, strings.Join(globalconfig.ValidTableStyleList(), `", "`)))
