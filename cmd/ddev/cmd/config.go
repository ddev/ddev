...
func init() {
	...
	ConfigCommand.Flags().StringVar(&projectTypeArg, "project-type", nodeps.AppTypeNone, projectTypeUsage)
	_ = ConfigCommand.RegisterFlagCompletionFunc("project-type", configCompletionFunc(ddevapp.GetValidAppTypes()))
	ConfigCommand.Flags().StringVar(&phpVersionArg, "php-version", nodeps.PHPDefault, "The version of PHP that will be enabled in the web container")
	...
	ConfigCommand.Flags().StringVar(&httpPortArg, "router-http-port", nodeps.DdevDefaultRouterHTTPPort, "The router HTTP port for this project")
	...
	ConfigCommand.Flags().StringVar(&httpsPortArg, "router-https-port", nodeps.DdevDefaultRouterHTTPSPort, "The router HTTPS port for this project")
	...
	ConfigCommand.Flags().StringVar(&webserverTypeArg, "webserver-type", nodeps.WebserverDefault, "Sets the project's desired webserver type: nginx-fpm/apache-fpm/generic")
	...
	ConfigCommand.Flags().StringVar(&mailpitHTTPPortArg, "mailpit-http-port", nodeps.DdevDefaultMailpitHTTPPort, "Router HTTP port to be used for Mailpit access")
	...
	ConfigCommand.Flags().StringVar(&mailpitHTTPSPortArg, "mailpit-https-port", nodeps.DdevDefaultMailpitHTTPSPort, "Router port to be used for Mailpit access (https)")
	...
	ConfigCommand.Flags().Bool("corepack-enable", false, `Do 'corepack enable' to enable latest yarn/pnpm'`)
