...
func init() {
	...
	ConfigCommand.Flags().StringVar(&httpPortArg, "router-http-port", "", "The router HTTP port for this project; alias for `--router-http-port`")
	_ = ConfigCommand.Flags().MarkHidden("http-port")
	ConfigCommand.Flags().StringVar(&httpsPortArg, "https-port", "", "The router HTTPS port for this project; alias for `--router-https-port`")
	_ = ConfigCommand.Flags().MarkHidden("https-port")
