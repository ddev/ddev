...
func init() {
	...
	ConfigCommand.Flags().String("nodejs-root", "", "The relative path, from the project root, to the directory Node.js version auto-detection reads its version file from (used with nodejs_version=auto or engine)")
