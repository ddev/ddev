...
environment there. The project_id and environment_name are injected into the
web container as $DDEV_PROVIDER_PROJECT_ID and $DDEV_PROVIDER_ENVIRONMENT_NAME
