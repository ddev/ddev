...
to allow ddev-hostname to modify the hosts file.
If you are connected to the internet and using the domain ddev.site this is generally not necessary,
...
func init() {
	...
	RootCmd.Flags().BoolVarP(&wslFlag, "wsl", "", false, "Use Windows hosts file inside WSL2")
