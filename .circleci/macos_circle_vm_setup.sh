...
brew install mysql-client zip makensis jq expect coreutils golang ddev mkcert mutagen-io/mutagen/mutagen osslsigncode ghr gnu-getopt libgsf glib pcre >/dev/null || true
