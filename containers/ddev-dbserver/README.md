...
The MySQL 8.0, 8.4, and 9.7 images build `FROM dhi.io/mysql` (Docker Hardened Images), which requires authentication. Before building those locally, run `docker login dhi.io` (Docker Hub credentials work).
