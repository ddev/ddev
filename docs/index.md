...
If not , and your linux distro was created earlier with version 1, you can convert it in Powershell: `wsl --set-version <distro> 2`. Replace `<distro>` with the shown distro name, that still uses version 1.   
