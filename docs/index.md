...
* Interactive community support on [Discord](https://discord.gg/x9srMwSH) for everybody, plus sub-channels for CMS-specific questions and answers.
* The `#ddev` channels in [Drupal Slack](https://drupal.org/slack), [TYPO3 Slack](https://my.typo3.org/index.php?id=35) for interactive, immediate community support. We hope to 
