...
| database | type and version of database to be used | Defaults to mariadb and 10.3, but mariadb 5.5 through 10.6 and MySQL 5.5 through 8.0 are available. See [Database Server Types](database_types.md) for details and caveats.  v1.18 and earlier uses of mariadb_version and mysql_version are automatically converted to this format.|
