...
| composer_version | version of composer to use in web container and `ddev composer` | It can be left blank to get the default for the current ddev version, or set to an explicit composer version. |
