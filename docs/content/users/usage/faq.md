...
This lets the `ddev-router` know that project A can access the web container on project B's DDEV URL. You can simply make calls now to project B via `https://projectb.ddev.site` from project A.
