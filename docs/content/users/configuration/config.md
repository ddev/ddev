...
| Type | Default                                                               | Usage
| -- |-----------------------------------------------------------------------| --
| :octicons-file-directory-16: project | [`ddev/ddev-webserver`](https://hub.docker.com/r/drud/ddev-webserver) | Specify your own image based on [drud/ddev-webserver](https://github.com/ddev/ddev/tree/master/containers/ddev-webserver).
