...
* If you're running WSL2 with Docker CE and VS Code on Windows check if `xdebug.discover_client_host` is on. If it is off add `xdebug.discover_client_host=1` to `.ddev/php/my-php.ini` in your project directory.
