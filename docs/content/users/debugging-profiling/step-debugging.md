...
* You may need to [open port 9003 in your firewall](https://stackoverflow.com/a/72591361) to allow Xdebug access. (See [Troubleshooting Xdebug](#troubleshooting-xdebug).)
