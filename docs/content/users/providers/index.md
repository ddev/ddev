...
Each DDEV project includes [example recipes](https://github.com/drud/ddev/tree/master/pkg/ddevapp/dotddev_assets/providers) in its `.ddev/providers` directory, which you can use and adapt however you’d like.
...
* All of the [supplied integrations](https://github.com/drud/ddev/tree/master/pkg/ddevapp/dotddev_assets/providers) are just examples of what you can do.
