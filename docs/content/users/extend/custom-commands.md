...
To run commands inside the web container, place a Bash script in the project `.ddev/commands/web`. To run a command such as `ddev webcommands`, create the file `.ddev/commands/web/webcommands` with this content:
