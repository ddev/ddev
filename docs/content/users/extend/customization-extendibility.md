...
See [Environment Variables](../configuration/environment-variables.md) for the `.ddev/.env*` files, their global equivalents, `web_environment`, and the order they override each other in.
