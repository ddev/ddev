...
=== "Git Clone"
    ...
    ```bash
    git clone <my-openamge-repo> my-openamge-site
    cd my-openamge-site
...
Your OpenMage project is now ready.
The admin page can be found at `/admin`, log into the default admin account using `admin` and `veryl0ngpassw0rd`.

To open the admin login page from CLI, run `ddev launch /admin`.
...
Visit the [documentation](https://docs.openmage.org) for more information.
