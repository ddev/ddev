...
* If you later want DDEV to take that file over again, just remove the one that you edited and [`ddev start`](../usage/commands.md#start) and DDEV will create its own version. (You may have to remove it from your Git project if you added it).
