...
=== "Windows"
    ...
    * Execute DDEV commands inside WSL2 (inside Ubuntu, for example). You will never execute DDEV commands on the Windows side, in PowerShell or Git Bash, for example.
