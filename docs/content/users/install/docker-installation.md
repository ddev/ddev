...
=== "Windows"
    ...
    The instructions for [DDEV Installation in WSL2](ddev-installation.md#wsl2-docker-ce-inside-install-script) include Docker Engine setup and a script that does almost all the work. Please use those.
