...
=== "macOS"
    ...
    4. After [installing DDEV](ddev-installation.md), make sure Mutagen is not disabled — essential for DDEV with Colima — with `ddev config global --performance-strategy=default`.
