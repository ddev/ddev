...
Run yarn inside the web container in the root of the project (Use --cwd for another directory) (global shell web container command)

```
ddev yarn [flags] [args]
```
...
{% highlight bash %}{% raw %}
  "ddev yarn install" or "ddev yarn add learna" or "ddev yarn --cwd web/core add learna"{% endraw %}{% endhighlight %}
