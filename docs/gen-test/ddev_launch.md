...
```
ddev launch [path] [-p|--phpmyadmin] [-m|--mailhog] [flags]
```
...
<dl class="flags">
	<dt><code>-m</code>, <code>--mailhog</code></dt>
	<dd>ddev launch -m launches the mailhog UI</dd>

	<dt><code>-p</code>, <code>--phpmyadmin</code></dt>
	<dd>ddev launch -p runs the PhpMyAdmin UI</dd>
</dl>
...
{% highlight bash %}{% raw %}
  "ddev launch" or "ddev launch /admin/reports/status/php" or "ddev launch phpinfo.php", for PHPMyAdmin "ddev launch -p", MailHog "ddev launch -m"{% endraw %}{% endhighlight %}
