...
<dl class="flags">
	...
	<dd>Defines the execution directory within the container</dd>

	<dt><code>--raw</code></dt>
	<dd>Use raw exec (do not interpret with bash inside container)</dd>
...
ddev exec --raw -- ls -lR{% endraw %}{% endhighlight %}
