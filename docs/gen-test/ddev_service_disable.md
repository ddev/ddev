...
{% raw %}## ddev service disable

```
ddev service disable service [project]
```

disable a 3rd party service. The docker-compose.*.yaml will be moved from .ddev into .ddev/.disabled-services.
...
{% highlight bash %}{% raw %}
ddev service disable solr{% endraw %}{% endhighlight %}
