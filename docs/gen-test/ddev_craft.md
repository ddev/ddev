...
Run Craft CMS command inside the web container (global shell web container command)

```
ddev craft [flags] [args]
```
...
{% highlight bash %}{% raw %}
  "ddev craft db/backup" or "ddev craft db/backup ./my-backups" (see https://craftcms.com/docs/4.x/console-commands.html){% endraw %}{% endhighlight %}
