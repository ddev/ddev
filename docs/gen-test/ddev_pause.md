...
```
ddev pause [projectname ...] [flags]
```

Uses "docker-compose stop" to pause/stop the containers belonging to a project. This leaves the containers instantiated instead of removing them like ddev stop does. You can run 'ddev pause'
...
<dl class="flags">
	...
	<dd>Pause all running projects</dd>
</dl>
