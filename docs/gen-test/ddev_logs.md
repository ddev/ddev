...
<dl class="flags">
	...
	<dd>Follow the logs in real time.</dd>

	<dt><code>-s</code>, <code>--service &lt;string&gt;</code></dt>
	<dd>Defines the service to retrieve logs from. [e.g. web, db]</dd>

	<dt><code>--tail &lt;string&gt;</code></dt>
	<dd>How many lines to show</dd>

	<dt><code>-t</code>, <code>--time</code></dt>
	<dd>Add timestamps to logs</dd>
</dl>
...
ddev logs -f
ddev logs -s db
ddev logs -s db [projectname]{% endraw %}{% endhighlight %}
