...
Requires a free or paid account on ngrok.com, use the "ngrok config add-authtoken <token>" command to set up ngrok. Although a few ngrok commands are supported directly, any ngrok flag can be added in the ngrok_args section of .ddev/config.yaml.
...
<dl class="flags">
	<dt><code>--basic-auth &lt;string&gt;</code></dt>
	<dd>works as in &#34;ngrok http --basic-auth username:pass1234&#34;</dd>

	<dt><code>--subdomain &lt;string&gt;</code></dt>
	<dd>requires a paid ngrok account, works as in &#34;ngrok http --subdomain mysite&#34;</dd>
</dl>
...
ddev share myproject{% endraw %}{% endhighlight %}
