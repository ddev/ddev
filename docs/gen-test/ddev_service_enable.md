...
{% raw %}## ddev service enable

```
ddev service enable service [project]
```

Enable a 3rd party service. The service must exist as .ddev/.disabled-services/docker-compose.<service>.yaml. Note that you can use "ddev get" to obtain a service not already on your system.
...
{% highlight bash %}{% raw %}
ddev service enable solr{% endraw %}{% endhighlight %}
