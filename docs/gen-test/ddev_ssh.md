...
```
ddev ssh [projectname] [flags]
```

Starts a shell session in the container for a service. Uses web service by default. To start a shell session for another service, run "ddev ssh --service <service>
...
<dl class="flags">
	...
	<dd>Defines the destination directory within the container</dd>

	<dt><code>-s</code>, <code>--service &lt;string&gt;</code></dt>
	<dd>Defines the service to connect to. [e.g. web, db]</dd>
</dl>
...
ddev ssh -d /var/www/html{% endraw %}{% endhighlight %}
