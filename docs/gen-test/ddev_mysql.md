...
run mysql client in db container (global shell db container command)
...
{% highlight bash %}{% raw %}
  "ddev mysql" or "ddev mysql -uroot -proot" or "echo 'SHOW TABLES;' | ddev mysql"{% endraw %}{% endhighlight %}
