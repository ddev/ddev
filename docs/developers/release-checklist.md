...
- [ ] [Create a release](https://github.com/drud/ddev/releases/new) using the github web UI. This will initiate a CircleCI tag build.
- [ ] Check out the ddev source with `git fetch upstream && git checkout <release_tag>`
- [ ] In each directory if containers/ do a `make push`.
