...
sudo rm -f /usr/local/bin/jq && sudo apt-get -qq install -y mysql-client postgresql-client zip jq expect build-essential curl git libnss3-tools libcurl4-gnutls-dev
